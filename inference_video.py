...
from models import UNet,BiSeNet
...
parser.add_argument('--checkpoint', type=str, default="/home/ql/pycharm/segmentation_demo/pretrain/BiSeNet_ResNet18.pth",
                    help='Path to the trained model file')

parser.add_argument('--video', type=str, default="/home/ql/pycharm/segmentation_demo/video/doctor.mp4",
                    help='Path to the input video')

parser.add_argument('--output', type=str, default="/home/ql/pycharm/segmentation_demo/result/doctor_output.mp4",
